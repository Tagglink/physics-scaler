...
function CalculatePhysics(scales) {
  for (let prop in scales) {
    if (Object.prototype.hasOwnProperty.call(scales, prop)) {
      scales[prop] = parseFloat(scales[prop]);
    }
  }

  let response = physics.calculate_scale(scales);
